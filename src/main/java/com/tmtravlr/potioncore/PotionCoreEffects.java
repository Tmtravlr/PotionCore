...
public class PotionCoreEffects {
	...
	public static void loadPotionEffects() {
		...
		if(ConfigLoader.modifyStrength) {
			strengthModified = new PotionAttackDamageModified(Potion.damageBoost.getId()).setPotionName("potion.damageBoost").registerPotionAttributeModifier(SharedMonsterAttributes.attackDamage, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 2.5D, 2);
		}
